...
#define    f(x)    (27*pow(x,3)/8 + 81*pow(x,2)/8 + 69*x/8 + 23/8)
#define    g(x)    x * (27*pow(x,3)/8 + 81*pow(x,2)/8 + 69*x/8 + 23/8)
#define    h(x)    ( (3* pow(x,2) - 1)/2) * (27*pow(x,3)/8 + 81*pow(x,2)/8 + 69*x/8 + 23/8)
